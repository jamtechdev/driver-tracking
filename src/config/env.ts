...
/** Local overrides from env.local.ts (gitignored, generated by npm run setup:mapbox). */
type LocalEnv = Partial<Pick<EnvConfig, 'MAPBOX_ACCESS_TOKEN'>>;
...
const defaultConfig: EnvConfig = {
  ...
  // Set via .env → npm run setup:mapbox (see .env.example)
