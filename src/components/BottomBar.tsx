...
//   const vehicleDisplay = vehicleName || '110';
...
//           <Pressable
//             style={[styles.item, isLoggedOut && styles.itemDisabled, isLandscape && styles.itemRow]}
...
//           <Pressable
//             style={[styles.item, (isLoggedOut || driver?.role !== 'supervisor') && styles.itemDisabled, isLandscape && styles.itemRow]}
//             onPress={() => !isLoggedOut && driver?.role === 'supervisor' && setShowVehicleModal(true)}
//             disabled={isLoggedOut || driver?.role !== 'supervisor'}
//             android_ripple={null}
//             hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }}
//           >
//             <MaterialIcons
//               name="directions-bus"
//               size={iconSize}
//               color={isLoggedOut ? COLORS.navBarIconDisabled : dynamicIconColor}
//               style={isLandscape ? undefined : styles.itemIcon}
//             />
//             <Text
...
const BottomBar: React.FC<BottomBarProps> = ({ navigation, onDriverPress }) => {
  ...
  const vehicleDisplay = emergencyActivated ? '110' : (vehicleName || '110');
