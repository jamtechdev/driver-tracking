...
//         // We stay in camera mode to allow capturing more images
//       } catch (e) {
...
//                 <View style={styles.cameraPreviewSide}>
...
//                   )}
//                 </View>
//                 <TouchableOpacity style={styles.captureSide} onPress={takePhoto} activeOpacity={0.8}>
...
//             <TouchableOpacity style={styles.barItem} onPress={handleCameraToggle}>
//               <MaterialIcons name={isCameraActive ? "close" : "camera-alt"} size={32} color="#FFF" />
//               <Text style={styles.barText}>{isCameraActive ? "Close" : "Camera"}</Text>
//             </TouchableOpacity>
